    ...
    <div class="col-lg-3">
        <div class="admin-sidebar mb-4">
            ...
            <div class="list-group list-group-flush">
                ...
                <a href="/jp-annahls/pages/admin_categories.php" class="list-group-item list-group-item-action active"><i class="bi bi-tags me-2"></i> Manajemen Kategori</a>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="d-flex justify-content-center gap-2">
                                                <a href="/jp-annahls/pages/admin_categories.php?action=edit&id=<?= $c['category_id'] ?>" class="btn btn-sm btn-outline-warning" title="Edit"><i class="bi bi-pencil"></i></a>
                                                <a href="/jp-annahls/pages/admin_categories.php?action=delete&id=<?= $c['category_id'] ?>" class="btn btn-sm btn-outline-danger confirm-delete" data-item-name="<?= esc($c['category_name']) ?>" title="Hapus"><i class="bi bi-trash"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
