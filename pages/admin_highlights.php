                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="/jp-annahls/pages/admin_highlights.php?action=edit&id=<?= $h['highlight_id'] ?>" class="btn btn-sm btn-outline-warning d-flex align-items-center justify-content-center" title="Edit" style="width: 32px; height: 32px; padding: 0;"><span class="material-icons-outlined" style="font-size: 1.15rem;">edit</span></a>
                                                <a href="/jp-annahls/pages/admin_highlights.php?action=delete&id=<?= $h['highlight_id'] ?>" class="btn btn-sm btn-outline-danger confirm-delete d-flex align-items-center justify-content-center" data-item-name="highlight <?= esc($h['product_name']) ?>" title="Hapus" style="width: 32px; height: 32px; padding: 0;"><span class="material-icons-outlined" style="font-size: 1.15rem;">delete</span></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
